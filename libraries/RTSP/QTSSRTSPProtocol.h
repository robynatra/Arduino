...
enum
{
    ...
    //ngod
    ngodNoticeHeader             = 62,
	ngodSessionGroupHeader	     = 63,
	ngodReasonHeader             =64,
	ngodOnDemandSessionIdHeader  =65,
	
	qtssNumHeaders				= 66, //62
	qtssIllegalHeader 			= 66  //62
...
enum
{
    ...
    qtssServerGatewayTimeout            = 45,       //504
    qtssRTSPVersionNotSupported         = 46,       //505
    qtssServerOptionNotSupported        = 47,       //551
    //NGOD
    ngodInvalidRequest                  = 48,       //671
    ngodQAMBandwidthNotAvailable        = 49,       //672
    ngodNetworkBandwidthNotAvailable    = 50,       //673
    ngodProgramNotAvailable             = 51,       //674
    ngodServiceGroupNotFound            = 52,       //675
    ngodQAMGroupsNotFound               = 53,       //676
    ngodQAMNotAvailable                 = 54,       //677
    ngodEdgeDeviceNotAvailable          = 55,       //678
    
    qtssNumStatusCodes                  = 56
    
};
//typedef UInt32 QTSS_RTSPStatusCode;
typedef int QTSS_RTSPStatusCode;

//NGOD Announce msg , Notice 
enum
{
    ngodEndOfSreamReached            = 0, //2101
    ngodStartofStreamReached         = 1, //2104 
    ngodErrorReadingContentData      = 2, //4400 
    ngodServerResourcesUnavailable   = 3, //5200 
    ngodDownstreamFailure            = 4, //5401 
    ngodClientSessionTerminated      = 5, //5402 
    ngodInternalServerError          = 6, //5502 
    ngodInbandStreamMarkerMismatch   = 7, //5601 
    ngodSessionInProgress            = 8  //5700   
};
//typedef UInt32 NGOD_AnnounceCode;

typedef int NGOD_AnnounceCode;
