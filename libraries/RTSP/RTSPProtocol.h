...
class RTSPProtocol
{
    public:
        ...
        //NGOD announce code
        static StrPtrLen&       GetAnnounceCodeString(NGOD_AnnounceCode inAnn)
            { return sAnnounceCodeStrings[inAnn]; }
        //
        static SInt32           GetAnnounceCode(NGOD_AnnounceCode inAnn)
            { return sAnnounceCodes[inAnn]; }
        //returns announce code as a string
        static StrPtrLen&       GetAnnounceCodeAsString(NGOD_AnnounceCode inAnn)
            { return sAnnounceCodeAsStrings[inAnn]; }
    ...
    private:
        ...
        //NGOD announce code
        static StrPtrLen            sAnnounceCodeStrings[];
        static StrPtrLen            sAnnounceCodeAsStrings[];
        static SInt32               sAnnounceCodes[];
